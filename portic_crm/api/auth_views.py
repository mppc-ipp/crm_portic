...
from portic_crm.core.permissions import (
    ...
    is_gestor_teletrabalho,

    user_can_access_module,

)

from portic_crm.core.rate_limit import rate_limit_login
...
class LoginAPIView(APIView):
    ...
    def post(self, request):
        ...
        if not rate_limit_login(f"{email}:{ip}"):
        ...
        if not user:
            ...
            registar_auditoria(
                ...
                AcaoAuditoria.LOGIN_FALHADO,

                f"Tentativa falhada para {email} (IP {ip})",
...
class LogoutAPIView(APIView):
    ...
    def post(self, request):
        ...
        registar_auditoria(
            ...
            f"Logout via API ({request.user.email or request.user.username})",
