...
const ROTULOS_ACAO: Record<string, string> = {
  ...
  TIPO_PARC_CRIADO: "Tipo de parceria criado",
  TIPO_PARC_EDITADO: "Tipo de parceria editado",
  TIPO_PARC_REMOVIDO: "Tipo de parceria removido/desactivado",
  ...
  VIATURA_CRIADA: "Viatura criada",
  VIATURA_EDITADA: "Viatura editada",
  VIATURA_ELIMINADA: "Viatura desactivada",
  SEG_AVISO_CRIADO: "Aviso de segurança criado",
  SEG_AVISO_EDITADO: "Aviso de segurança editado",
  SEG_AVISO_REMOVIDO: "Aviso de segurança removido",
  SEG_OCOR_CRIADA: "Ocorrência de segurança registada",
  SEG_OCOR_EDITADA: "Ocorrência de segurança editada",
  SEG_OCOR_REMOVIDA: "Ocorrência de segurança removida",
  SEG_EVENTO_CRIADO: "Evento de segurança criado",
  SEG_EVENTO_EDITADO: "Evento de segurança editado",
  SEG_EVENTO_REMOVIDO: "Evento de segurança removido",
  SEG_TIPO_EVT_CRIADO: "Tipo de evento de segurança criado",
  SEG_TIPO_EVT_EDITADO: "Tipo de evento de segurança editado",
  SEG_TIPO_EVT_REMOVIDO: "Tipo de evento de segurança removido",
  SEG_TIPO_OCOR_CRIADO: "Tipo de ocorrência criado",
  SEG_TIPO_OCOR_EDITADO: "Tipo de ocorrência editado",
  SEG_TIPO_OCOR_REMOVIDO: "Tipo de ocorrência removido/desactivado",
