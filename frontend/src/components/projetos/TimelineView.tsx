  ...
  return (
    <div className="flex-1 overflow-auto p-4">
      <p className="mb-4 text-sm text-slate-500">
        Arraste as barras para ajustar datas. Tarefas sem datas aparecem a partir de hoje.
      </p>
          ...
          <div key={b.id} className="flex items-center gap-2 py-1 hover:bg-slate-50">
            ...
            <div className="relative h-8 flex-1 rounded bg-slate-100">
              <div
                ...
                className={`absolute top-1 h-6 cursor-grab rounded-md px-2 text-[10px] font-medium leading-6 text-white shadow-sm active:cursor-grabbing ${
                  b.estado === "CONCLUIDO"
                    ? "bg-emerald-500"
